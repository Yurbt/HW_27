...
select name, id from students where id='117';
...
select name, id from students where id<'190' and id>'180';
-- 25. Вывести пользователя у которых id между 180 и 190  не понятно, что значит "между", включая границы или нет, я включил
select name, id from students where id<='190' and id>='180';
-- 26. Вывести пользователей где password равен 12333, 1m313, 123313
select name, password id from students where password in('12333','1m313','123313');
